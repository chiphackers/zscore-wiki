...
function compileMarkdown() {
  ...
  var originalEl = document.getElementById('originalContent'); // || document.getElementsByTagName('xmp')[0] || document.getElementsByTagName('textarea')[0],
  var markdownEl = document.getElementById('markdownContent');
  ...
  */
  ...
  /*
  var linkEl = document.createElement('link');
  linkEl.href = originBase + '/custom-strapdown.css';
  linkEl.rel = 'stylesheet';
  document.head.appendChild(linkEl);
  */
  ...
  */
  ...
  var markdown = originalEl.textContent || originalEl.innerText; // markdownEl.textContent || markdownEl.innerText;

  //var newNode = document.createElement('div');
  //newNode.className = 'container';
  //newNode.id = 'content';
  
  //document.getElementById('parentIncludedContent').replaceChild(newNode, markdownEl);
  originalEl.style.display = 'none';
  markdownEl.style.display = 'inherit';
  document.getElementById('parentIncludedContent').style.display = 'none';
  ...
  */
  ...
  // All done - show body
  document.getElementById('parentIncludedContent').style.display = 'inherit';
